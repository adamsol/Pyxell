                ...
                CExt _ t' -> do
                    ...
                    forM membs $ \m -> case findMember membs' (idMember m) of
                        Just (_, t, _) -> case reduceType t of
                            TFunc {} -> skip  -- TODO check method compatibility as well
...
checkAssgs pos exprs types cont = do
    case (exprs, types) of
        ([], []) -> cont
        ...
        checkBinary pos op expr1 expr2 = do
            ...
            case op of
                "*" -> case (t1', t2') of
                    ...
                    (TArray {}, TInt _) -> return $ (t1, False)
                    (TInt _, TArray {}) -> return $ (t2, False)
        ...
        checkCmp pos op typ1 typ2 = do
            ...
            case unifyTypes typ1 typ2 of
                Just t' -> case t' of
                    ...
                    TFunc {} -> throw pos $ NotComparable typ1 typ2
                    TClass {} -> case op of
