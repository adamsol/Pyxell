...
main = do
    ...
    case args of
        ...
        path:clangArgs -> do
            ...
            readProcess "clang" ([file ++ ".ll", "lib/io.ll", "lib/base.ll", "lib/math.ll", "-o", file ++ ".exe", "-v", "-O2"] ++ clangArgs) ""
            return $ ()
