...
instance Print (Stmt a) where
  prt i e = case e of
    ...
    SAssgCoalesce _ expr1 expr2 -> prPrec i 0 (concatD [prt 0 expr1, doc (showString "??="), prt 0 expr2])
...
instance Print (Expr a) where
  prt i e = case e of
    ...
    ECoalesce _ expr1 expr2 -> prPrec i 2 (concatD [prt 3 expr1, doc (showString "??"), prt 2 expr2])
