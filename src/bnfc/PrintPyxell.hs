...
instance Print (Expr a) where
  prt i e = case e of
    ...
    ERange _ expr1 expr2 -> prPrec i 6 (concatD [prt 7 expr1, doc (showString ".."), prt 7 expr2])
    ERangeStep _ expr1 expr2 expr3 -> prPrec i 6 (concatD [prt 7 expr1, doc (showString ".."), prt 7 expr2, doc (showString ".."), prt 7 expr3])
